...
public interface IPrinterCategory
{
    ...
    /// <param name="defer">Флаг отложенной печати <a href="https://integration.atol.ru/api/?csharp#pechat-shtrihkoda">Документация</a></param>
    /// <returns>KktBaseResponse</returns>
    ...
    /// <returns>KktBaseResponse</returns>
    KktBaseResponse PrintImageFromMemory(int imageNumber, int leftMargin, Defer defer, TextAlignment alignment = TextAlignment.Center);
